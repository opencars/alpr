...
// Source: github.com/opencars/alpr/pkg/store (interfaces: Store,RecognitionRepository)
...
func (m *MockStore) Recognition() store.RecognitionRepository {
	...
	ret0, _ := ret[0].(store.RecognitionRepository)
	return ret0
}
...
func (m *MockRecognitionRepository) FindByPlate(arg0 context.Context, arg1 string) ([]store.Recognition, error) {
	...
	ret0, _ := ret[0].([]store.Recognition)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
