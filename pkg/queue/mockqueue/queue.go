...
// Source: github.com/opencars/alpr/pkg/domain (interfaces: Publisher,Subscriber)
...
func (m *MockPublisher) Publish(arg0 *model.Event) error {
	m.ctrl.T.Helper()
...
func (m *MockSubscriber) Subscribe(arg0 context.Context) (<-chan *model.Event, error) {
	m.ctrl.T.Helper()
